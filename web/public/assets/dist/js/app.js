...
angular.module('Auth', [])
    ...
    .controller("AuthController", ['$scope', '$filter', 'AuthService', '$cookies', function ($scope, $filter, AuthService, $cookies) {
        $scope.register = function () {
            if ($scope.registerForm.$valid) {
                var data = {name: this.name, email: this.email, password: this.password, cfpassword: this.cfpassword}
        ...
        $scope.updateMyAccount = function () {
            var data = {email: this.user.email, name: this.user.name}
        ...
        $scope.reset = function () {
            var data = {newPassword: this.newPassword, confirmNewPassword: this.confirmNewPassword}
